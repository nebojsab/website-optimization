...
function sizeSwitcher (size) {
  ...
  switch(size) {
    ...
    default:
      console.log("run for your lives sizeSwitcher");
  }
}
...
function changeSliderLabel(size) {
  switch(size) {
    ...
    case "3":
      ...
      return;
    default:
      console.log("run for your lives changeSliderLabel");

  }
}

// randomPizzaContainer dom element
// Moved out of resizePizzas() - global
...
var resizePizzas = function(size) {
  ...
  console.log("Resize pizzas: " + timeToResize[0].duration + "ms");
};
...
console.log("Generate pizzas on load: " + timeToGenerate[0].duration + "ms");
...
function generateBackground(){
  ...
  // Made background pizzas number based on window size
